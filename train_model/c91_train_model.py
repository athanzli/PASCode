...
# %%
adata = sc.read_h5ad(DATA_PATH + 'c91.h5ad')
adata_pac = sc.read_h5ad(DATA_PATH + 'c91_30v30.h5ad')
...
adata.obs['c91_30v30_mask'] = adata.obs.index.isin(adata_pac.obs.index)
...
# NOTE
adata.write_h5ad(DATA_PATH + 'c91.h5ad')
adata_pac.write_h5ad(DATA_PATH + 'c91_30v30.h5ad')
...
torch.save(model.state_dict(), './trained_models/c91_model.pt')

#%%
model.load_state_dict(torch.load('./trained_models/c91_model.pt'))
